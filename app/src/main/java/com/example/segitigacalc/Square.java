...
public class Square extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView pLabel = findViewById(R.id.pLabel);
        ...
        lBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                lBtn.setBackground(ContextCompat.getDrawable(Square.this, R.drawable.text_main_bg));
                lBtn.setTextColor(ContextCompat.getColor(Square.this, R.color.white));
                lBtn.setTypeface(lBtn.getTypeface(), Typeface.BOLD);

                kBtn.setBackground(ContextCompat.getDrawable(Square.this, R.drawable.btn_bg_2_bg));
                kBtn.setTextColor(ContextCompat.getColor(Square.this, R.color.text_main));
                kBtn.setTypeface(kBtn.getTypeface(), Typeface.NORMAL);

                pLabel.setText("p = ");

                illustration.setImageResource(R.drawable.squareluas);
                formulaDisp.setText(R.string.square_luas);
            }
        });
        ...
        kBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                kBtn.setBackground(ContextCompat.getDrawable(Square.this, R.drawable.text_main_bg));
                kBtn.setTextColor(ContextCompat.getColor(Square.this, R.color.white));
                kBtn.setTypeface(kBtn.getTypeface(), Typeface.BOLD);

                lBtn.setBackground(ContextCompat.getDrawable(Square.this, R.drawable.btn_bg_2_bg));
                lBtn.setTextColor(ContextCompat.getColor(Square.this, R.color.text_main));
                lBtn.setTypeface(lBtn.getTypeface(), Typeface.NORMAL);
                
                pLabel.setText("s = ");

                illustration.setImageResource(R.drawable.squarekel);
                formulaDisp.setText(R.string.square_keliling);
            }
        });
        ...
        countBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pInput.getText().toString().isEmpty()) {
                    Toast.makeText(Square.this, "Nilai harus diisi!", Toast.LENGTH_SHORT).show();
                    return;
                }
